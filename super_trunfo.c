...
int main() {
    ...
    char cityNameC1[50], stateC1[4], letterCodeC1[6];
    char cityNameC2[50], stateC2[4], letterCodeC2[6];
    ...
    printf("População: Carta 1 venceu (%d)\n", comparisonResultPopulation);
    printf("Área: Carta 1 venceu (%d)\n", comparisonResultCityArea);
    printf("PIB: Carta 1 venceu (%d)\n", comparisonResultGrossDomesticProduct);
    printf("Pontos Turísticos: Carta 1 venceu (%d)\n", comparisonResultTouristAttraction);
    printf("Densidade Populacional: Carta 2 venceu (%d)\n", comparisonResultPopulationDensity);
    printf("PIB Per Capita: Carta 1 venceu (%d)\n", comparisonResultgrossDomesticProductPerCapita);
    printf("Super Poder: Carta 1 venceu (%d)\n", comparisonResultSuperPower);
